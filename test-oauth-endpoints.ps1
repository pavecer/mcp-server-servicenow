...
$endpoint = "https://YOUR_FUNCTION_APP_NAME.azurewebsites.net"
...
try {
    $settings = (az functionapp config appsettings list -g "rg-dev" -n "YOUR_FUNCTION_APP_NAME" | ConvertFrom-Json)
