...
- [ ] **Verify Entra app registration exists**
  ...
  - Search for client ID `ENTRA_CLIENT_ID_PLACEHOLDER`
...
- [ ] **API scope exposed**
  - Expose an API → Application ID URI = `api://ENTRA_CLIENT_ID_PLACEHOLDER`
...
- [ ] **Test OIDC discovery endpoint directly**
  ```
  https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/.well-known/openid-configuration
  ```
...
- [ ] **Check function app logs**
  - Azure Portal → Function App `YOUR_FUNCTION_APP_NAME`
  - Go to Monitor → Logs
...
- [ ] **Use the correct MCP URL**
  - Server URL: `https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/mcp`
  - Authentication: `OAuth 2.0`
  - Type: `Dynamic discovery`
  - **NOT** `https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/api/...`

- [ ] **Ensure correct tenant context**
  - Sign in to Copilot Studio with an account in tenant `ENTRA_TENANT_ID_PLACEHOLDER`
...
3. Search for application ID `ENTRA_CLIENT_ID_PLACEHOLDER`
...
2. Application ID URI: Set to `api://ENTRA_CLIENT_ID_PLACEHOLDER`
...
3. Server URL: `https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/mcp`
4. Authentication: `OAuth 2.0`
5. Type: `Dynamic discovery`
6. Click **Create**
7. When prompted to sign in → Use account from tenant `ENTRA_TENANT_ID_PLACEHOLDER`
...
$response = Invoke-WebRequest `
  -Uri "https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/.well-known/openid-configuration" `
  -Method GET
...
| Component | Value |
|-----------|-------|
| Tenant ID | `ENTRA_TENANT_ID_PLACEHOLDER` |
| Entra Client ID | `ENTRA_CLIENT_ID_PLACEHOLDER` |
| Function App | `YOUR_FUNCTION_APP_NAME` |
| MCP Endpoint | `https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/mcp` |
| OIDC Discovery | `https://YOUR_FUNCTION_APP_NAME.azurewebsites.net/.well-known/openid-configuration` |
| ServiceNow Instance | `https://YOUR_SERVICENOW_INSTANCE.service-now.com/` |
