...
```
https://login.microsoftonline.com/f8cdef31-a31b-4234-b2be-1234567890ab/adminconsent?client_id=ENTRA_CLIENT_ID_PLACEHOLDER&redirect_uri=https://oauth.botframework.com/callback&scope=api://ENTRA_CLIENT_ID_PLACEHOLDER/access_as_user
```
